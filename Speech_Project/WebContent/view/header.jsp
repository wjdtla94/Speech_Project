		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><img
					src="/Speech_Project/images/logo30.png" alt=""> Web Speech
					Service</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a href="index.jsp"><i class="icon-home icon-white"></i>
							Home</a></li>
					<li><a href="setting.jsp"><i class="icon-th icon-white"></i>
							Setting</a></li>
					<li><a href="explanation.jsp"><i
							class="icon-th icon-white"></i> Explanation</a></li>
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="login.jsp"><i
							class="icon-th icon-white"></i> login</a></li>
					<li><a href="user.jsp"><i
							class="icon-th icon-white"></i> register</a></li>
